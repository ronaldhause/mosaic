...
#sampleinfo5<-loc1
#save(sampleinfo5,file='/net/shendure/vol3/data/nobackup/hauser/Shendure/msi/batch5_sampleinfo_040115.robj')
#load('/net/shendure/vol3/data/nobackup/hauser/Shendure/msi/batch5_sampleinfo_040115.robj') #needs reordered
#sampleinfo5<-sampleinfo5[match(sampledat5$sample_name,sampleinfo5$SAMPLE_NAME),]
#save(sampleinfo5,file='/net/shendure/vol3/data/nobackup/hauser/Shendure/msi/batch5_sampleinfo_041515.robj')
load('/net/shendure/vol3/data/nobackup/hauser/Shendure/msi/batch5_sampleinfo_041515.robj')
...
#colnames(sampledat5)<-c('sample_name','peak_avg','peak_sd','num_unstable_ks','num_unstable_raw','msi_status_rf','msi_status_tree','msi_status_rf_scaled','msi_status_tree_scaled','tumor_type')
...
load('/net/shendure/vol3/data/nobackup/hauser/Shendure/msi/batch3_sampledata_030115.robj')
load('/net/shendure/vol3/data/nobackup/hauser/Shendure/msi/batch4_sampledata_030115.robj')
sampledat<-rbind(sampledat1,sampledat2,sampledat3,sampledat5)
...
load('/net/shendure/vol3/data/nobackup/hauser/Shendure/msi/batch4_sampleinfo_030115.robj')
...
library(ggplot2)
alllocs<-rbind(sampleinfo1,sampleinfo2,sampleinfo3,sampleinfo4)
...
pdf('/net/shendure/vol3/data/nobackup/hauser/Shendure/msi/msi_prop_batch1-4.pdf',width=7*1.5,height=7)
